//Zaki Hilmi , June 11th 2015, Expressions
...
var result = "This is the total surface area" + " " +totalSurfaceArea + "cm2" + " "+"and this is the volume as calculated" + " " + theVolume + "cm3";
 // This alert will be giving the final calculations for both (total of surface area and the volume of the box)
alert(result );
